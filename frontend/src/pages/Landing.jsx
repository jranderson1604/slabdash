        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Link to="/login"
                className="flex items-center gap-1.5 text-xs sm:text-sm font-bold transition-colors px-2.5 py-1.5 sm:px-0 sm:py-0 rounded-lg sm:rounded-none"
                style={{ color: '#2C2416', background: window.innerWidth < 640 ? undefined : undefined }}>
                <Lock className="w-3.5 h-3.5 sm:hidden" />
                <span>Admin</span>
                <span className="hidden sm:inline">Login</span>
              </Link>
              <Link to="/register"
                className="px-3 sm:px-4 py-2 text-xs sm:text-sm font-bold text-white rounded-xl transition-all hover:opacity-90 whitespace-nowrap"
