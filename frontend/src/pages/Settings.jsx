    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl" style={{ background: 'var(--hdr-gradient)', boxShadow: 'var(--hdr-shadow)', border: 'var(--hdr-border)' }}>
        ...
        <div className="relative px-6 sm:px-8 py-7">
          <p className="text-[10px] font-bold uppercase tracking-[0.15em] mb-1" style={{ color: 'var(--hdr-eyebrow)' }}>Configuration</p>
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight leading-tight" style={{ color: 'var(--hdr-title)' }}>Settings</h1>
          <p className="text-sm font-medium mt-1" style={{ color: 'var(--hdr-sub)' }}>Manage your SlabDash configuration</p>
        </div>
      </div>
