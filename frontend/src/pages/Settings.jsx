    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-500 via-brand-600 to-brand-700 shadow-xl">
        ...
        <div className="relative px-6 sm:px-8 py-7">
          <p className="text-white/50 text-[10px] font-bold uppercase tracking-[0.15em] mb-1">Configuration</p>
          <h1 className="text-3xl sm:text-4xl font-black text-white tracking-tight leading-tight">Settings</h1>
          <p className="text-white/60 text-sm font-medium mt-1">Manage your SlabDash configuration</p>
        </div>
      </div>
