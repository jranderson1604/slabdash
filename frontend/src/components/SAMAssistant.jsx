...
export default function SAMAssistant() {
  ...
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: '👋 Hey there! I\'m SAM (Submission Assistant Manager), your SlabDash assistant! Ask me anything about tracking your PSA submissions, managing customers, or using SlabDash features!',
      timestamp: new Date()
    }
  ]);
          ...
          <div className="bg-gradient-to-r from-brand-600 to-brand-700 text-white p-4 rounded-t-2xl flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-white/90">Submission Assistant Manager</p>
              </div>
            </div>
            <button
