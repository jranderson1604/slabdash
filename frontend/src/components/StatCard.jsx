  ...
  const content = (
    <div className="flex items-center gap-4">
      ...
      <div>
        ...
        <p className="text-sm font-medium" style={{ color: 'rgb(var(--bg-text))' }}>{label}</p>
        {subtext && <p className="text-xs mt-0.5" style={{ color: 'rgb(var(--bg-text))', opacity: 0.7 }}>{subtext}</p>}
      </div>
    </div>
  );
