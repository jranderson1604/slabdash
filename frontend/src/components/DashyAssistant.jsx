    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-20 h-20 bg-brand-600 hover:bg-brand-700 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 z-50 group"
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 w-96 h-[600px] bg-brand-50 rounded-2xl shadow-2xl flex flex-col z-50 border border-brand-200">
          {/* Header */}
                ...
                <div
                  className={`max-w-[80%] rounded-2xl px-4 py-2 ${
                    msg.role === 'user'
                      ...
                      : 'bg-brand-100 border border-brand-200 text-gray-900'
                  }`}
                >
          ...
          {/* Quick Questions */}
          {messages.length === 1 && (
            <div className="px-4 py-2 border-t border-brand-200 bg-brand-50">
          ...
          {/* Input */}
          <div className="p-4 border-t border-brand-200 bg-brand-50 rounded-b-2xl">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-transparent text-gray-900 placeholder-gray-400"
                disabled={isLoading}
              />
              <button
                onClick={handleSend}
